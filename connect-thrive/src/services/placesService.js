...
//   // Filter out unnamed places, sort by name, take top 8
//   return elements
//     .filter((el) => el.tags?.name)
//     .slice(0, 8)
//     .map(formatPlace);
...
//   // Way elements have a center, nodes have direct lat/lon
//   const lat = element.lat ?? element.center?.lat ?? null;
//   const lng = element.lon ?? element.center?.lon ?? null;

//   // Build a rough address from OSM tags
//   const location =
//     [tags["addr:street"], tags["addr:city"] || "Kurukshetra"]
//       .filter(Boolean)
//       .join(", ") || tags.vicinity || "Kurukshetra";
...
//     totalRatings: 0,
//     isOpen: null,        // OSM doesn't provide live hours
//     photo: null,         // OSM doesn't provide photos
//     types: [tags.amenity || tags.tourism || tags.leisure || "place"].filter(Boolean),
//     priceLevel: parsePriceLevel(tags.fee || tags["price:level"]),
//     lat,
//     lng,
//     website: tags.website || null,
